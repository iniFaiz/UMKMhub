<template>
  <div v-if="!umkm" class="min-h-screen flex items-center justify-center bg-[#FAE7CB]/30">
    <div class="text-center px-6 py-16 animate-fade-in">
      <div class="w-24 h-24 mx-auto mb-6 rounded-full bg-white text-[#59B292] flex items-center justify-center shadow-sm">
      ...
      <h1 class="text-4xl md:text-5xl font-bold text-gray-800 mb-4">UMKM Tidak Ditemukan</h1>
  ...
  <div v-else class="min-h-screen bg-gray-50">
        ...
        <div class="lg:col-span-3 space-y-6">
          ...
          <article class="info-card">
            ...
            <div class="flex items-center gap-4">
              ...
              <div>
                <p class="font-semibold text-gray-800 text-lg">{{ umkm.namaPemilik }}</p>
          ...
          <article class="info-card">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <a :href="'tel:' + umkm.kontak.telepon" class="contact-card">
                ...
                <span class="min-w-0">
                  ...
                  <span class="contact-value">{{ umkm.kontak.telepon }}</span>
                </span>
              </a>
              <a :href="'https://wa.me/' + umkm.kontak.whatsapp.replace(/[^0-9]/g, '')" target="_blank" class="contact-card">
                <span class="contact-icon bg-green-100 text-green-600">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span class="min-w-0">
                  ...
                  <span class="contact-value">{{ umkm.kontak.whatsapp }}</span>
                </span>
              </a>
              <a :href="'https://instagram.com/' + umkm.kontak.instagram.replace('@', '')" target="_blank" class="contact-card">
                <span class="contact-icon bg-pink-100 text-pink-600">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span class="min-w-0">
                  ...
                  <span class="contact-value">{{ umkm.kontak.instagram }}</span>
                </span>
              </a>
              <a :href="'mailto:' + umkm.kontak.email" class="contact-card">
                <span class="contact-icon bg-blue-100 text-blue-600">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span class="min-w-0">
                  ...
                  <span class="contact-value">{{ umkm.kontak.email }}</span>
                </span>
              </a>
            </div>
          </article>
            ...
            <div class="overflow-hidden rounded-xl border border-gray-100">
              <table class="w-full">
                <tbody>
                  ...
                  >
                    <td class="px-4 py-3.5 text-sm font-medium text-gray-700">{{ jadwal.hari }}</td>
          ...
          <article class="info-card">
            ...
            <div class="flex flex-wrap gap-2">
              <span
                ...
                :key="metode"
                class="inline-flex items-center gap-1.5 px-4 py-2 rounded-full text-sm font-medium bg-[#FAE7CB]/50 text-gray-700 border border-[#FAE7CB]"
              >
          ...
          <article class="info-card">
            ...
            <div class="flex items-start gap-3 p-4 rounded-xl bg-gradient-to-r from-[#FAE7CB]/30 to-transparent">
              ...
              <p class="text-gray-600 leading-relaxed">{{ umkm.alamat }}</p>
            </div>
            <div v-if="mapEmbedUrl" class="mt-4 overflow-hidden rounded-2xl border border-gray-100 bg-gray-100">
              <iframe
                :src="mapEmbedUrl"
          ...
          <div class="lg:sticky lg:top-24">
            <div class="bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-gray-100">
              <h2 class="text-xl font-bold text-gray-800 mb-6 flex items-center gap-2">
                ...
                Produk / Menu
                <span class="ml-auto text-xs font-medium text-gray-400 bg-gray-100 px-2.5 py-1 rounded-full">
              ...
              <div class="space-y-3">
                <div
                  ...
                  :key="index"
                  class="group p-4 rounded-xl border border-gray-100 hover:border-[#59B292]/30 hover:bg-[#59B292]/[0.03] transition-all duration-300 cursor-default"
                >
                  <div class="flex items-start justify-between gap-3 mb-1.5">
                    <h3 class="font-semibold text-gray-800 text-sm leading-snug group-hover:text-[#59B292] transition-colors">
                      {{ produk.nama }}
                    </h3>
                    <span class="shrink-0 text-sm font-bold text-[#59B292] bg-[#59B292]/10 px-2.5 py-0.5 rounded-lg whitespace-nowrap">
                      Rp {{ formatPrice(produk.harga) }}
                    </span>
                  </div>
                  <p class="text-xs text-gray-500 leading-relaxed">{{ produk.deskripsi }}</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-14">
      <div>
        ...
        <p class="text-gray-500 mb-8 ml-[52px]">Lihat suasana dan produk kami lebih dekat</p>
      ...
      <div v-if="recommendedUmkm.length" class="mt-16">
        <div class="flex items-center justify-between gap-4 mb-6">
          <div>
            ...
            <h2 class="text-2xl md:text-3xl font-bold text-gray-800">Tempat Serupa</h2>
          </div>
          <router-link
            :to="{ name: 'SearchResult', query: { q: umkm.kategori } }"
            class="hidden sm:inline-flex items-center gap-2 text-sm font-semibold text-[#59B292] hover:text-[#478f76]"
          >
            Lihat kategori
...
.contact-card:hover {
  background: rgb(89 178 146 / 0.05);
}
